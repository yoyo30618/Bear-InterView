<?php
	...
	if(isset($_POST['CardID'])&&isset($_POST['Week'])&&isset($_POST['ClassEng'])&&isset($_POST['Class']))//如果是由post進入
	{
		...
		if($StudentID=="")	//檢查有沒有找到該生
			echo"<script  language=\"JavaScript\">alert('查無學生，請檢查學生證');location.href=\"RollCall.php?ClassEng=".$_POST['ClassEng']."&Class=".$_POST['Class']."&Week=".$_POST['Week']."&CardID=".$StudentID."\";</script>";			
		else{	
			/*檢查該生是否有修本課程*/
		...
		//跳轉回本來點名頁面
		echo"<script  language=\"JavaScript\">;location.href=\"RollCall.php?ClassEng=".$_POST['ClassEng']."&Class=".$_POST['Class']."&Week=".$_POST['Week']."&CardID=".$StudentID."\";</script>";		
	}
	else//不當路徑進入
