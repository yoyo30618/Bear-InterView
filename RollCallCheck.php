<?php
	...
	if(isset($_POST['CardID'])&&isset($_POST['Week'])&&isset($_POST['ClassEng'])&&isset($_POST['ClassCht']))//如果是由post進入
	{
		...
		//跳轉回本來點名頁面
		echo"<script  language=\"JavaScript\">;location.href=\"RollCall.php?ClassEng=".$_POST['ClassEng']."&ClassCht=".$_POST['ClassCht']."&Week=".$_POST['Week']."&ClassRoom=".$_POST['ClassRoom']."\";</script>";		
	}
	else//不當路徑進入
